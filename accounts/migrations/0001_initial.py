    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('studentDoubleMajor', models.CharField(default=None, max_length=30, null=True)),
                ('studentTrack', models.CharField(default=None, max_length=30, null=True)),
                ('studentSubMajor', models.CharField(default=None, max_length=30, null=True)),
                ('studentConvergenceMajor', models.CharField(default=None, max_length=30, null=True)),
                ('studentTeaching', models.CharField(default=None, max_length=30, null=True)),
